...
$(n,b,r)$ as shown in Figure \ref{fig:2}. For each setting $(n,b,r)$, we generate randomly five instances and  compute the mean of five running times. \rev{The degree of random cases are between $10$ to $1500$, the coefficients  belong to $[-17951,17951]$ and the value of $r$ belongs to $\{0.1,0.2,c\dots, 0.9\}$.} In almost every randomly generated benchmark, \froot\  is  faster than other  solvers. And we can also  find that
