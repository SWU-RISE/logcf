...
\begin{corollary}
	...
	\ref{thm:log}}. Then  {\em Algorithm \ref{alg:up}} costs at most $O(n\log(u+1))$  addition and multiplication \rev{symbolic operators}.
\end{corollary}
