\begin{abstract}
  ...
  faster   than  the function {\tt RootIntervals} of \MM. And it  is much faster than   another continued fractions based on software \cf, which seems to be one of the
