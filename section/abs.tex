\begin{abstract}
  ...
  Theorem \ref{thm:log} and  $n$ is the degree of the polynomial. Our  method has been implemented as a  software package \froot\ using \texttt{C++} language. For many benchmarks \froot \  is mean four  times
  faster   than  the function {\tt realroot} of \MAPLE. {\color{red}In some cases \froot\ is slow than the function {\tt \inte} of \MM, but we find that there is a bug in  {\tt \inte} during we test. And it  is also much faster than   open source real root solver.}
