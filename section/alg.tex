...
\rev{ For {\em Example \ref{ex:exp1}}, $V(p_1)=V(5,-5,10,1,-4,2,1)=3$.  {\em Descartes' rule of signs} is a usefual tool to estimate the number of  real roots. And if $V(p)=1$, then employ this rule, there is 
