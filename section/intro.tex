...
main algorithm for real root isolation based on  continued fraction. We present some theoretically results about  upper bounds of positive roots in section \ref{sec:thm}.  In section \ref{sec:alg}, we present a new algorithm for
